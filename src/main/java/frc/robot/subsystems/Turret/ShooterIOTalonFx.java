...
public class ShooterIOTalonFx implements ShooterIO{
    ...
    public void updateInputs(ShooterInputs inputs){
        inputs.isMotorConnected = m_shooter.isConnected();
        inputs.acc = m_shooter.getAcceleration().getValueAsDouble();
        inputs.velocity = m_shooter.getVelocity().getValueAsDouble();
    }
    @Override
