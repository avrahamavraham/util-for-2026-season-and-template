    ...
    public ElevatorIOSim() {
        Sim = new ElevatorSim(
                LinearSystemId.createElevatorSystem(
                        ElevatorConstants.SimConstants.dcMotor,
                        ElevatorConstants.SimConstants.MassKg,
                        ElevatorConstants.SimConstants.drumMetersRiauds,
                        ElevatorConstants.SimConstants.gearRatio),
                ElevatorConstants.SimConstants.dcMotor,
                ElevatorConstants.minHightMeters,
                ElevatorConstants.maxHightMeters,
                true,
                ElevatorConstants.startingHight);
