...
public class ArmConstants {
    ...
    public final class MotionMagicConstants {
        public static final LoggedNetworkNumber KP = new LoggedNetworkNumber("Tuning/Arm/KP",0);
        public static final LoggedNetworkNumber KI = new LoggedNetworkNumber("Tuning/Arm/KI",0);
        public static final LoggedNetworkNumber KD = new LoggedNetworkNumber("Tuning/Arm/KD",0);
        public static final LoggedNetworkNumber KV = new LoggedNetworkNumber("Tuning/Arm/KV",0);
        public static final LoggedNetworkNumber KA = new LoggedNetworkNumber("Tuning/Arm/KA",0);
        public static final LoggedNetworkNumber KS = new LoggedNetworkNumber("Tuning/Arm/KS",0);
        public static final LoggedNetworkNumber KG = new LoggedNetworkNumber("Tuning/Arm/KG",0);
        public static final LoggedNetworkNumber Expo_KV = new LoggedNetworkNumber("Tuning/Arm/EXPO_KV",0);
        public static final LoggedNetworkNumber Expo_KA = new LoggedNetworkNumber("Tuning/Arm/EXPO_KA",0);
