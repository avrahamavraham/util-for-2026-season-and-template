...
public class Drive extends SubsystemBase {
  ...
  public Drive(
    ...
    // SignalLogger.setPath("u/logsignal");
    // SignalLogger.start();
  ...
  public void joystickDriveRobotRelitve(double x, double y, double rot) {
    SwerveModuleState state =
        new SwerveModuleState(MetersPerSecond.of(x + y), Rotation2d.fromRotations(rot));
    for (var module : modules) {
