...
public class GripperIOSim implements GripperIO{
    ...
    public GripperIOSim(){
        Sim = new FlywheelSim(LinearSystemId.createFlywheelSystem(GripperConstants.dcMotor, 0.001, GripperConstants.gearRatio), GripperConstants.dcMotor);
            TalonFXConfiguration talonFXConfiguration = new TalonFXConfiguration();
            FeedbackConfigs feedbackConfigsspin = talonFXConfiguration.Feedback;
            feedbackConfigsspin.SensorToMechanismRatio =
            GripperConstants.POSITION_CONVERSION_FACTOR;
            ...
            GripperConstants.MotionMagicConstants.MOTION_MAGIC_VELOCITY;
            motionMagicConfigs.MotionMagicAcceleration =
            GripperConstants.MotionMagicConstants.MOTION_MAGIC_ACCELERATION;
            motionMagicConfigs.MotionMagicJerk =
            GripperConstants.MotionMagicConstants.MOTION_MAGIC_JERK;
            motionMagicConfigs.MotionMagicExpo_kA = 
            GripperConstants.MotionMagicConstants.Expo_KV.get();
