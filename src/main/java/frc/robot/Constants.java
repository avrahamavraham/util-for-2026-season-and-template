...
public final class Constants {
  ...
  public static final double ROT_REEF_ALIGNMENT_P = 5;

  public static final double ROT_SETPOINT_REEF_ALIGNMENT = 110; // Rotation
  public static final double ROT_TOLERANCE_REEF_ALIGNMENT = 0;
  public static final double X_SETPOINT_REEF_ALIGNMENT = -0.2; // Vertical pose
  public static final double X_TOLERANCE_REEF_ALIGNMENT = 0;
  public static final double Y_SETPOINT_REEF_ALIGNMENT = -0.36; // Horizontal pose
