...
public final class PhoenixUtil {
    ...
    public static class DCmotorSimControllerSim implements SimulatedMotorController{
        private static int instances = 0;
        public final int id;

        private final DCMotorSim dcMotorSim;

        public DCmotorSimControllerSim(DCMotorSim dcMotorSim) {
            this.id = instances++;
        ...
        public Voltage updateControlSignal(
            ...
            dcMotorSim.setAngle(mechanismAngle.in(Radian) / dcMotorSim.getGearing());
            dcMotorSim.setAngularVelocity(mechanismVelocity.in(RadiansPerSecond) / dcMotorSim.getGearing());
            dcMotorSim.setInputVoltage(SimulatedBattery.getBatteryVoltage().in(Volts));
            return Volts.of(dcMotorSim.getInputVoltage());
        }
    }
